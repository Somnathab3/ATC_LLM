...
class LlamaClient:
    ...
    def __init__(self, model_name="llama3.1:8b",
                 ...
                 timeout=30, use_mock=False):
        self.model_name = model_name
        self.host = host.rstrip("/")
        self.timeout = timeout
        self.use_mock = use_mock

    def _get_mock_json_response(self, kind: str):
    ...
    def call_json(self, prompt: str, schema_hint: str = None,
                  retries: int = 1):
    ...
    def _parse_detect_response(self, obj: dict):
    ...
    def _parse_resolve_response(self, obj: dict):
