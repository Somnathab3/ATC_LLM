...
1. Batch flight input support from multiple SCAT files ✓
2. Monte Carlo intruder generation using KDTree-based spatial search ✓
3. LLM-based conflict detection and resolution ✓
